...
export default function HeroVideoScroll({ masterTl }: Props) {
  ...
  //   masterTl.current.addLabel("hero-start");

  //   masterTl.current.to(frameObj, {
  //     frame: TOTAL_FRAMES - 1,
  //     duration: 5, // controls scroll duration of swan
  //     ease: "none",
  //     onUpdate: () => render(frameObj.frame),
  //   });

  //   // 🔥 fade canvas out before logo
  //   masterTl.current.to(canvas, {
  //     autoAlpha: 0,
  //     duration: 1,
  //   });
  ...
  //   // 🔥 this is the trigger point for logo
  //   masterTl.current.addLabel("swan-fade-start", "-=1");
  ...
  //     defaults: { ease: "none" },
  //     onComplete: () => {
  //       console.log("Hero animation fully completed 🔥");
  //     },
  //   });
  ...
  //   // 🔥 IMPORTANT: clear previous timeline if re-render
  ...
  //   heroTl.to(frameObj, {
  //     frame: TOTAL_FRAMES - 1,
  //     duration: 1, // duration doesn't matter much in scrub, keep 1
  //     snap: "frame", // ✅ important
  //     onUpdate: () => {
  //       render(frameObj.frame);
  //     },
  //     onComplete: () => {
  //       render(TOTAL_FRAMES - 1); // freeze last frame
  //       console.log("Hero animation completed");
  //     },
  //   });

  //   // 👇 This fade should happen ONLY after frames end
  //   heroTl.to(canvas, {
  //     autoAlpha: 0,
  //     duration: 0.2,
  //   });
  ...
  //   masterTl.current.add(heroTl, ">");
  //   console.log("Hero added properly");
  // }, [images]);
